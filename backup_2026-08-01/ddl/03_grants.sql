...
-- Write access, scoped to the three tables the workflows update
GRANT UPDATE ON TABLE MENDIX_APP.AGENTS.BILL_OF_LADING TO ROLE VF_APP_ROLE;
GRANT UPDATE ON TABLE MENDIX_APP.AGENTS.FRAUD_ALERT TO ROLE VF_APP_ROLE;
